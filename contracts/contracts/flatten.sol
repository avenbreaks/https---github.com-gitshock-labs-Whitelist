...
// File @openzeppelin/contracts/interfaces/IERC20.sol@v4.8.0
...
contract Arnhemia is ERC721URIStorage, Ownable, ReentrancyGuard{
    ...
    **/
    ...
    constructor(string memory _baseURI, string memory collectionURI) ERC721("Arnhemia", "ARH") {
        setBaseURI(_baseURI);
